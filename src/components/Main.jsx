import { MdOutlineFavorite, MdMoreVert } from "react-icons/md";
...
const MainContent = () => {
  const recentPlaylists = [
    ...
    },
    {
      ...
      name: "Chill Out",
      description: "Relájate con estos beats",
    cover: "https://akamai.sscdn.co/letras/360x360/albuns/f/a/a/d/1485721731068565.jpg",
    },
  ];
  ...
  return (
    <main className="flex-1 p-4 md:p-6 overflow-y-auto bg-gradient-to-b from-green-900 to-gray-900">
      <section className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold mb-6">Buenos días</h1>
      ...
      <section className="mt-10">
        <h2 className="text-xl md:text-2xl font-bold mb-4">Episodios para ti</h2>
